<?php 
    function viewcart($del){
        ...
        echo '
                <tr>
                    <td><img src="' . $hinh . '" height="50px" width="60px"></td>
                    <td>' . $cart[1] . '</td>
                    <td>' . $cart[3] . '</td>
                    <td>
                    ...
                    <form action="index.php?act=updatequantity" method="post">
                        ...
                        <input type="number" class="form-control sl" name="newquantity" onchange="this.form.submit()"
                            value="' . $cart[4] . '" min="1" max="10">
                    </form>
                    </div>
                    </td>
                    <td>'.$ttien.'</td>
    ...
    function bill_chi_tiet($listbill){
        ...
        echo '
            ...
            foreach ($listbill as $cart) {
                ...
                $total_item = $cart['soluong'] * $cart['price'];
                $tong += $total_item ;
                echo '
                    <tr>
